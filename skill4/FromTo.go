...
// Write a function that takes two integers and returns a string showing the range of numbers 
// from the first to the second.

// The numbers must be separated by a comma and a space.
// If any of the arguments is bigger than 99 or less than 0, the function returns Invalid followed 
// by a newline \n.
